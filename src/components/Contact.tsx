  ...
  return (
    <div className="contactContainer" title="contact">
      <div className="aboutContainer" title="about">
        <img
          src="https://media-exp1.licdn.com/dms/image/C5103AQGmXL1iQ2b0OA/profile-displayphoto-shrink_800_800/0/1517235139683?e=1646870400&v=beta&t=QszHY-zugOMOhgphIO8GAgM9k1GMGUxwBGV92JOo0S4"
          alt="Magnus Sjöström"
        />
        <div className="introduction">
          <Typography variant="h6">Magnus Sjöström</Typography>
          <Typography variant="body1">
            Director, writer and producer of thought provoking documentaries and
            factual series. Vivid visual storytelling. Captivating characters
            and cases.
          </Typography>
        </div>
      </div>
      <div className="secondSection">
        <div className="introduction">
          ...
          <Link
            ...
            href="mailto:MagnusSjostromMedia@gmail.com"
          >
            MagnusSjostromMedia@gmail.com
          </Link>
          <Link className="aboutButton" href="tel:+46707531599">
            +46(0)70-7531599
          </Link>
          <div>
            <Button
              className="button"
              variant="contained"
              href="https://www.linkedin.com/in/magnus-sj%C3%B6str%C3%B6m-18227659/?originalSubdomain=se"
            >
              <FontAwesomeIcon
                className="icon"
            ...
            <Button
              className="button"
              variant="contained"
              href="https://www.imdb.com/name/nm6912800/"
            >
