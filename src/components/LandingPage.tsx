    ...
    const favourite = snapshot?.map((fav, i) => {
        return (
            <div className="featuredContainer" key={i} style={{ background: "black" }}>
                ...
                <div className="featuredWrapper">
                    <Typography color="white" variant='h5'>{fav.titleSwedish}</Typography>
                    <Typography color="white" variant='body1'>{fav.descriptionSV}</Typography>
                </div>
            </div >
        )
    })
            ...
            <div className="heroContainer">
                ...
                <div className="genrePickerContainer">
                    ...
                    <ButtonGroup className="buttonGroup">
                        ...
                        <Link className="category" to="/genre/science" style={{ textDecoration: "none" }}>
                            <Button className="categoryButton" variant="text">
                                <Typography variant='h6'>Science & Tech</Typography>
                            </Button>
                        </Link>

                        <Link className="category" to="/genre/history" style={{ textDecoration: "none" }}>
                            <Button className="categoryButton" variant="text">
