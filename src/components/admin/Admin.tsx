...
export const Admin = () => {
    const [messages] = useCollectionData(collection(getFirestore(firebaseApp), "messages"))
        ...
        <div className="adminContainer">
            {!user ?
                <div className="loginForm">
                    ...
                    <Button className="loginButton" variant="contained" onClick={login}>Log In</Button>
                </div>
                    ...
                    <Box sx={{ width: '100%' }}>
                        <TabContext value={value}>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <Badge badgeContent={messages?.length} color="primary" className="badge">
                            ...
                            <TabPanel value="1"><AdminTitles /></TabPanel>
                            <TabPanel value="2"><AdminMessages /></TabPanel>
                        </TabContext>
                    </Box>
                </div>}
        </div>
