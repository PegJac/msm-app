    ...
    <div className="adminCardContainer">
        ...
        return (
          <div key={key}>
            <MessageCard
              key={key}
              item={item}
              reply={() => setReplyMessage(item)}
              deleteMessageFunction={() => setDeleteMessage(item)}
            />
          </div>
        );
      })}
      ...
      {replyMessage ? (
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>{replyMessage.message}</DialogContentText>
            <TextField
              autoFocus
              margin="dense"
              fullWidth
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              color="warning"
              variant="contained"
              onClick={() => deleteMessageFunction(deleteMessage)}
            >
              Delete
            </Button>
          </DialogActions>
